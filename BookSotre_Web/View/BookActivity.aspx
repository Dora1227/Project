<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookActivity.aspx.cs" Inherits="View_BookActivity" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="currentPage" runat="server" Value="Activity"/>
        <!--底部信息-->
        <div>
